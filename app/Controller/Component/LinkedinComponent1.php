...
class LinkedinComponent extends Component {
	 ...
	 */
	public function initialize(&$controller, $settings = array('key' => '0f3hwj8z40c9', 'secret' => 'KjLZX97sRsjRgFCP')) {
	...
	$this->Session->write($this->sessionRequest,unserialize(serialize($_SESSION['linkedin_request_token'])));
		if (!isset($redirectUrl)) {
	...
	public function call($path, $args) {
		$this->Session->write($this->sessionAccess,unserialize(serialize($_SESSION['linkedin_access_token'])));
