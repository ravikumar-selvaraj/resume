<?php 
	 $portdoc=ClassRegistry::init('Portdocument')->find('first',array('conditions'=>array('key'=>$this->params['pass'][0]))); 
	?>
...
<form class="form-inline" name="update" action="" enctype="multipart/form-data" method="post" >
