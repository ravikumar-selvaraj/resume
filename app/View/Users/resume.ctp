                ...
                <div class="span5 middle-col">
                    <!--Display Proffessional Experiance-->
					 ...
					 if(!empty($exp)){ ?>
                            ...
                            foreach($exp as $exp) { 
                            ?>
                            <div class="exp-box clearfix"  onmouseover="mousein()" onmouseout="mouseout()">
                            ...
                            <a  href="<?php echo BASE_URL.'users/edit_resume/experience/'.$exp['Experience']['key'];?>"  class="pull-right  edit_proffessional" id="edit_proffessional">
                        Edit</a> 
                    ...
                    <!--Display Education-->
                     <?php if(!empty($edu)){  ?>
                        <div class="proff-exp resume-box-cont" onmouseover="mousein()" onmouseout="mouseout()">
                     ...
                     <ul class="edith unstyled" style="display:none">
                            ...
                            <?php // echo BASE_URL.'users/edit_resume/'.$exp['Experience']['eid'];?>
                            <a  href="<?php echo BASE_URL.'users/edit_resume/education/'.$edu['Education']['key'];?>"  class="pull-right  " id="">
                        Edit</a> 
                    ...
                    <div class="proff-exp resume-box-cont">
                     ...
                     <?php if(!empty($portimg)){  ?>
                        ...
                        <ul class="thumbnails" onmouseover="mousein()" onmouseout="mouseout()">
                        <li class="span5">
                        <a href="#" class="thumbnail">
                        <?php  echo  $this->html->image('portfolio-images/big/'.$portimg['Portimage']['image'],array('border'=>0,'alt'=>'pic'),array('class'=>'thumbnail')); ?>
                        </a>
                        </li>
                         <li class="edith" style="display:none; float:right;"><i class="icon-white"></i>
                             <?php  if(isset($_SESSION['User']['uid'])) { if(($_SESSION['User']['username']==Configure::read('userpage'))) { ?>
                          
                         
                            <?php // echo BASE_URL.'users/edit_resume/'.$exp['Experience']['eid'];?>
                            <a  href="<?php echo BASE_URL.'users/edit_portfolio/photo/'.$portimg['Portimage']['key'];?>"  class="pull-right  " id="">
                        Edit</a> 
...
<param value="<?php echo $this->Html->webroot('player_mp3_maxi.swf'); ?>" name="movie"> <param value="mp3=<?php echo $this->Html->webroot('files/portfolio-audios/'.$portaud['Portaudio']['audio_file'].''); ?>&amp;showstop=1&amp;showvolume=1&amp;bgcolor1=ffa50b&amp;bgcolor2=d07600" name="FlashVars">
                ...
                <div class="span4 right-col">
                    ...
                    <ul class="edith unstyled" style="display:none">
                            ...
                            <?php // echo BASE_URL.'users/edit_resume/'.$exp['Experience']['eid'];?>
                            <a  href="<?php echo BASE_URL.'users/edit_resume/skills/'.$skill['Skill']['key'];?>"  class="pull-right" >
                        Edit</a> 
                    ...
                    <?php // echo BASE_URL.'users/edit_resume/'.$exp['Experience']['eid'];?>
                    <a  href="<?php echo BASE_URL.'users/edit_resume/interest/'.$int['Interest']['key'];?>"  class="pull-right" >
                    Edit</a> 
