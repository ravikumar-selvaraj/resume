								...
								<form id="form-wizard" class="form-horizontal ui-formwizard" method="post" novalidate="novalidate" _lpchecked="1">
									<div id="form-wizard-1" class="step ui-formwizard-content" style="display: block;">
										<div class="control-group">
											...
											<div class="controls"> <?php echo h($blogs['Blog']['title']); ?></div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls"><?php echo $this->html->image('blog-images/small/'.$blogs['Blog']['image'],array('border'=>0,'alt'=>h($blogs['Blog']['title']))); ?></div>
										</div>
										<div class="control-group">
											<label class="control-label">Status :</label>
											<div class="controls"><?php echo h($blogs['Blog']['status']); ?></div>
										</div>
									</div>
