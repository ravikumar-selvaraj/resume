<div class="content">
    <div class="cont-container">
        ...
        <fieldset>
            ...
            <dl class="inline">
    			<?php
		echo $this->Form->input('fid',array('div'=>false,'error'=>false,'label' => array('text'=>'fid<span class="required">*</span>'), 'before' => '<dt>', 'after' => '</dd>', 'between' => '</dt><dd>', 'class'=>'validate[required]'));
