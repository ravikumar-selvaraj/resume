...
<?php $portimg=ClassRegistry::init('Portimage')->find('first',array('conditions'=>array('piid'=>$piid)));  ?>

<div id="editportimg<?php echo $piid; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:440px;">
<form class="form-inline" name="update" action="<?php echo BASE_URL; ?>users/edit_port_photo" method="post" enctype="multipart/form-data" style="margin-bottom:0px;width:440px;">
 <input type="hidden" name="data[piid]" value="<?php echo $portimg['Portimage']['piid'];?>"  />
    <div class="modal-header" style="margin-bottom:10px;padding-bottom:0px;">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      <h2 id="myModalLabel" style="font-size:16px; padding:0px; margin:0px; background:none"><?php echo __("Portfolio Photo");?></h2>
    </div>
    ...
    <div class="modal-body" style="padding-top:0px;width:500px;" >
      ...
      <div class="control-group" id="image_title_div">
       <label class="control-label" for="inputInfo" id="prof" style="width:500px; font-size:14px;font-family: arial; font-size: 14px;font-weight: bold; background:none"><?php echo __("Image Title");?></label>
        <div class="controls">
          <input type="text" placeholder="Portfolio Title" id="image_title" name="data[image_title]" style="padding:2px; margin-right:25px; width:345px;" value="<?php echo $portimg['Portimage']['image_title'];?>">          
      ...
      <div class="control-group" id="port_image_div">
        ...
        echo  $this->html->image('portfolio-images/small/'.$portimg['Portimage']['image'],array('border'=>0,'alt'=>'pic'),array('class'=>'thumbnail')); ?>
                    ...
                    <input type="file" placeholder="First Name" id="port_image" name="data[image]" style="padding:2px; margin: 15px 0px 0px 50px; height:26px;"> 
