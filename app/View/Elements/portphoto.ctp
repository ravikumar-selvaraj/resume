...
<form class="form-inline" name="update" action="<?php echo Router::url('/'); ?>portfolio/portphoto" method="post" enctype="multipart/form-data" style="margin-bottom:0px;width:440px;">
    <div class="modal-header" style="margin-bottom:10px;padding-bottom:0px;">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      <h2 id="myModalLabel" style="font-size:16px; padding:0px; margin:0px;"><?php echo __("Portfolio Photo");?></h2>
    </div>
    <div class="modal-body" style="padding-top:0px;width:500px;" >
    
      <div class="control-group" id="image_title_div">
       <label class="control-label" for="inputInfo" id="prof" style="width:500px; font-size:14px;font-family: arial; font-size: 14px;font-weight: bold;"><?php echo __("Image Title");?></label>
        <div class="controls">
          <input type="text" placeholder="Portfolio Title" id="image_title" name="data[image_title]" style="padding:2px; margin-right:25px; width:345px;">          
