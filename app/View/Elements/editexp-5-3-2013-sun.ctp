<?php $exp=ClassRegistry::init('Experience')->find(array('eid'=>$edid));
...
<form class="form-inline" name="update" action="<?php echo Router::url('/'); ?>users/exp" method="post" style="margin-bottom:0px;" enctype="multipart/form-data">
    ...
    <div class="modal-body" style="padding-top:0px;" >
      ...
      <div class="control-group" id="job_title_div">
       ...
       <div id="delme1" style="display:none; float:left; width:50px;">
       <a id="delimg1" onclick="return scat();" style="cursor:pointer; color:#foo"><img src="<?php echo Router::url('/'); ?>img/delete.png" width="18" height="18" /></a></div>
        <div class="controls">
        ...
        <div class="cp-bl" style="width:150px; float:right;" id="mylogo2edit">
        ...
        <div style="width:150px; float:right; height:50px; display:none; text-align:center; position:relative; bottom:25px;" id="mylogoedit">
