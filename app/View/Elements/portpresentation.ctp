...
<form class="form-inline" name="update" action="<?php echo Router::url('/'); ?>portfolio/portpresent" method="post" style="margin-bottom:0px;width:440px;">
    <div class="modal-header" style="margin-bottom:10px;padding-bottom:0px;">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      <h2 id="myModalLabel" style="font-size:16px; padding:0px; margin:0px;"><?php echo __("Portfolio Add Slideshow");?></h2>
    </div>
    <div class="modal-body" style="padding-top:0px;width:440px;" >
      ...
      <div class="control-group" id="present_title_div">
       <label class="control-label" for="inputInfo" id="prof" style="width:440px; font-size:14px;font-family: arial; font-size: 14px;font-weight: bold;"><?php echo __("Presentation Title");?></label>
        <div class="controls">
          <input type="text" placeholder="Presentation Title" id="present_title" name="data[present_title]" style="padding:2px; margin-right:25px; width:345px;">
      ...
      <div class="control-group" id="present_code_div">
                   <label class="control-label" for="inputInfo" id="prof" style="width:440px; font-size:12px;font-family: arial; font-size:10px;"><?php echo __("Insert Embed Code");?></label>
                    <div class="controls">
                 <textarea rows="2" cols="5" id="present_code" name="data[present_code]" style="width:340px;"></textarea>
