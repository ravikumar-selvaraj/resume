<?php 	 $portpre=ClassRegistry::init('Portpresent')->find('first',array('conditions'=>array('ppid'=>$pp))); 	?>

<div id="editportpres<?php echo $pp; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:440px;">
<form class="form-inline" name="update" action="<?php echo BASE_URL; ?>users/edit_port_presentation" method="post" >

<input type="hidden" name="data[ppid]" value="<?php echo $portpre['Portpresent']['ppid'];?>"  />
    <div class="modal-header" style="margin-bottom:10px;padding-bottom:0px;">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      <h2 id="myModalLabel" style="font-size:16px; padding:0px; margin:0px; background:none"><?php echo __("Portfolio Edit Slideshow");?></h2>
    </div>
