...
<div id="#ver_content23"><div>sdgdfg</div></div>
  ...
  <div  class="modal hide fade recommendtr" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="recommend-skills">
                                        <p><?php echo __('Recommand '.Configure::read('userpage').'on one of his key-skills'); ?></p>
                                         ...
                                         <button class="btn btn-info"><?php echo substr($recskill['Recommentation']['skills'],0,5); ?>
                                               ...
                                               <?php /*?> <span><?php if($_SESSION['User']['username']==Configure::read('userpage')) { ?><a href=""><i class="icon-remove pull-right"></i></a><?php } ?></span><?php */?>
                                                <div class=" resume_head">
                                                   ...
                                                   <?php if($_SESSION['User']['username']==Configure::read('userpage')) { ?>
                                                    ...
                                                    <a onClick="acknowledge(this.id,this.rel)" id="ok" rel="<?php echo $recomment['Recomment']['rid']; ?>" style="cursor:pointer"><span class="label label-success"><?php echo __('Ok') ?></span></a>
                                                    <a onClick="acknowledge(this.id,this.rel)" id="refuse" rel="<?php echo $recomment['Recomment']['rid']; ?>" style="cursor:pointer"><span class="label label-important"><?php echo __('Refuse')?></span></a>
                                                    </div>
                                                    <?php } ?>
                                                    </h5>
									...
									<?php } ?> 
                                      ...
                                      <a href="" class="btn btn-block" type="button"> <button class="btn btn-block" type="button" ><?php echo __('Go back to '.Configure::read('userpage').' resume'); ?></button></a>
                                    </div>
                                </div>
...
<div class="recommend-fix" style="display:none" id="refoot">
			...
			foreach($recedu as $recedu)
			 ...
			 { $recbtn1_for_first=count(ClassRegistry::init('Recomment')->find('all',array('conditions'=>array('rid'=>$recedu['Recommentation']['rid'])))); ?>
                <a href="#" class="ex2" rel="<?php echo $recedu['Recommentation']['rid'];?>" data-placement="top"><button class="btn">
				<?php  echo substr($recedu['Recommentation']['skills'],0,5) ; ?>
                <span class="badge badge-success" style="padding:2px; margin-left:5px;">
				<?php if($recbtn1_for_first!=0) echo $recbtn1_for_first; ?></span></button></a>
                
                <?php $j++; }
				 $i++; } 
				 if($j!=6) { ?>
                  <a href="" class="" data-toggle="modal" data-target=".recommendtr" style="color:#fff; cursor:pointer"><?php echo __('More'); ?></a>
                   <!--<a  class="onloadpop1"  href="#myModal" data-placement="top" style="color:#fff; cursor:pointer"><?php echo __('More'); ?></a>-->
...
<div id="ver_content" style="display:none; background:#fff">
  ...
  <div class="norecm same_rec" style="display:none: color:#f00;"><?php echo __('To recommend on self is not possible,sorry!'); ?></div>
  
   <div class="norecm again_rec" style="display:none color:#f00;"><?php echo __('One recommendation by Tag possible.'); ?></div>
   
     <div class="norecm success_rec" style="display:none">
     <?php echo __('Your recommendation sent succssfully waiting for approval'); ?>
     <br /> <br />
     <a href="<?php echo BASE_URL; ?><?php echo Configure::read('userpage'); ?>" style="color:#397; cursor:pointer; font-size:12px; border:none; text-decoration:underline"><?php echo __('Back to resume'); ?></a>
     </div>
  ...
  <!--Recomment text box-->
   ...
   <!-- <div class="norecm ajaxloading" style="display:none;">
    <img src="<?php echo BASE_URL; ?>img/ajax-loader.gif" alt="" style="padding-right:15px;"></div>-->
   ...
   <div class="resumebtn">
     ...
     <button class="btn btn-large btn-primary disabled recmbtn1" id="recmbtn" style="display:none;cursor:pointer" onClick="sentrecomment()"> 
...
$('.ex2').popover({
	...
	content: function() {
		...
		$('.again_rec').show();	
		$('.popover').css({'top':'-100px','background':'#000'});
		$('.recme').hide();	
		$('.recm_code').hide();	
		$('.resumebtn').hide();
		$('.same_rec').hide();
