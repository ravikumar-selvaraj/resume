               ...
               <div class="container">
					...
					?>
                        ...
                        <div class="span2 pull-right language">
                            ...
                            <a href="<?php echo BASE_URL;?>pages/change/eng" <?php if($this->Session->read('Config.language') == 'eng') echo 'class="lang_active"';?>><img src="<?php echo Router::url('/'); ?>img/page/eng.png" alt="english" title="<?php echo __("English");?>"></a>
                            <a href="<?php echo BASE_URL;?>pages/change/spa" <?php if($this->Session->read('Config.language') == 'spa') echo 'class="lang_active"';?>><img src="<?php echo Router::url('/'); ?>img/page/es.png" alt="spanish" title="<?php echo __("Spanish");?>"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="footer">
            <div class="container">
                ...
                ?>
					...
					<section class="span4 pull-right footer-links">
						<p>&nbsp;</p>
						<p class="pull-right">Designed &amp; Developed by <a target="_blank" style="color:#fff;" href="http://www.aparajayah.com">Aparajayah</a></p>
					</section>
                </div>
