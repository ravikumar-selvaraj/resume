<div class="content">        
     ...
     <?php } ?>
			...
			<div class="well">
					...
					<input type="hidden" name="data[aid]" value="<?php echo $this->request->data['Adminuser']['aid'];?>" />
						...
						<input type="password" name="data[password]" id="password" value="<?php echo $this->request->data['Adminuser']['password'];?>"  class="validate[required] input-xlarge"></textarea>
						<label>Email</label>
						...
						<select name="data[status]" id="status" class="validate[required] input-xlarge">
						  <option value="Active" <?php if($this->request->data['Adminuser']['status'] == 'Active') echo 'selected="selected"';?>>Active</option>
						  <option value="Inactive" <?php if($this->request->data['Adminuser']['status'] == 'Inactive') echo 'selected="selected"';?>>Inactive</option>
					</select>
